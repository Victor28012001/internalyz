                                                ...
                                                <td className="p-3 pl-0">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="flex flex-col justify-start">
                                                            <Link to="javascript:void(0)" className="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> Social Media API </Link>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr className="border-b border-dashed last:border-b-0">
                                                <td className="p-3 pl-0">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="flex flex-col justify-start">
                                                            <Link to="javascript:void(0)" className="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> Geolocation App </Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="p-3 pr-0 text-end">
                                            ...
                                            <tr className="border-b border-dashed last:border-b-0">
                                                <td className="p-3 pl-0">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="flex flex-col justify-start">
                                                            <Link to="javascript:void(0)" className="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> iOS Login <span className="text-sm">(Morra)</span></Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="p-3 pr-0 text-end">
                                            ...
                                            <tr className="border-b border-dashed last:border-b-0">
                                                <td className="p-3 pl-0">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="flex flex-col justify-start">
                                                            <Link to="javascript:void(0)" className="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> Axios Menu </Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="p-3 pr-0 text-end">
                                            ...
                                            <tr className="border-b border-dashed last:border-b-0">
                                                <td className="p-3 pl-0">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="flex flex-col justify-start">
                                                            <Link to="javascript:void(0)" className="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> Resto Aperto </Link>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="p-3 pr-0 text-end">
