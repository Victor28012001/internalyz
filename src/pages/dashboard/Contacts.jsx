...
const Contacts = () => {
  ...
  return (
    <Dashboards>
      <div className='flex  w-[100%] mt-[80px] pb-12'>
        {/* <div className='flex flex-col'> */}
        {/* <!-- component --> */}
        <section class="relative min-h-screen flex flex-col justify-center pb-3 pt-64 bg-slate-50 overflow-scroll antialiased w-[70%]">
                ...
                <div class="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:ml-[8.75rem] md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
                  ...
                  <div class="relative">
                    ...
                    <div class="bg-white p-4 rounded border border-slate-200 text-slate-500 shadow ml-14 md:ml-44">
                      ...
                      <div onClick={() => setLoading(!loading)} className="w-[25%] bg-indigo-500 duration-150 hover:!border-b-2 text-blue-950 rounded-xl drop-shadow-lg group flex items-center text-white cursor-pointer">
                        <div className="py-2 px-3">
                          {loading ? 'Loading...' : 'Click to load'}
                        </div>
                        <div className={`${loading ? 'opacity-100 scale-100 duration-200 w-auto py-2 pr-3' : 'opacity-0 scale-0 duration-100 w-0 p-0'}`}>
                  ...
                  <div class="relative">
                    ...
                    <div class="bg-white p-4 rounded border border-slate-200 text-slate-500 shadow ml-14 md:ml-44">
                      ...
                      <div onClick={() => setLoading(!loading)} className="w-[25%] bg-indigo-500 duration-150 hover:!border-b-2 text-blue-950 rounded-xl drop-shadow-lg group flex items-center text-white cursor-pointer">
                        ...
                        <div className={`${loading ? 'opacity-100 scale-100 duration-200 w-auto py-2 pr-3' : 'opacity-0 scale-0 duration-100 w-0 p-0'}`}>
                          <svg class="animate-spin h-5 w-5 mr-3 ... border-white" viewBox="0 0 24 24" />
                        </div>
                      </div>
                    </div>
                  </div>
