    ...
    return (
        <Dashboards>
            <div className="lg:grid lg:grid-cols-12 lg:gap-x-16 w-[70%] mt-12">
                ...
                <ol className="mt-4 divide-y divide-gray-100 text-sm leading-6 lg:col-span-7 xl:col-span-8 relative overflow-scroll px-2">
                    ...
                    <li className="relative flex-col space-x-6 py-6 xl:static bg-white rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg shadow-md px-3 mb-3">
