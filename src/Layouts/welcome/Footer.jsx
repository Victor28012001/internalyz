    ...
    <footer className="bg-indigo-600 text-white dark:bg-white-900">
      <div className="container px-6 py-12 mx-auto">
        <div className="text-center">
          ...
          <p className="max-w-md mx-auto mt-2 text-white-500 dark:text-white-400">Join over 4,000+ startups already growing with Meraki UI.</p>
        ...
        <div className="grid grid-cols-2 gap-6 mt-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
          <div>
            ...
            <div className="flex flex-col items-start mt-4 space-y-4">
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Pricing</Link>
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Releases</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-4 space-y-4">
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">About us</Link>
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Press</Link>
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Media kit</Link>
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-4 space-y-4">
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Help center</Link>
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Tutorials</Link>
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-4 space-y-4">
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Enterprise</Link>
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Saas</Link>
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Marketplaces</Link>
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Ecommerce</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-4 space-y-4">
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Github</Link>
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">AngelList</Link>
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Dribble</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-4 space-y-4">
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Cookies</Link>
              ...
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Settings</Link>
              <Link to="#" className="text-white-700 transition-colors duration-200 dark:text-white-200 dark:hover:text-blue-400 hover:underline">Contact</Link>
            </div>
          </div>
        </div>
